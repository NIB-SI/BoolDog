...
class RegulatoryNetwork(BooleanGraph):
    ...
    def __init__(self, graph, **kwargs):
        ...
        graph : squad_reboot.BooleanGraph, dict or str
            ...
            a squad_reboot.BooleanGraph.

        Other Parameters
        ----------
        **kwargs
            Additional arguments and keyword arguments passed to
            squad_reboot.BooleanGraph. For description of these arguments see
            help(squad_reboot.ODE).
        '''
    ...
    def transform_bool_to_continuous(self, transform, **kwargs):
        ...
        ----------
        transform : str
            One of accepted transforms. See `squad_reboot.ode_transforms` for
            options.
        ...
        **kwargs
            Additional arguments and keyword arguments passed to
            squad_reboot.ODE. For description of these arguments see
            help(squad_reboot.ODE).
        '''
