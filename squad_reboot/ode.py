...
def ODE(graph, transform, **kwargs):
    ...
    **kwargs
    ...
    `help(squad_reboot.ode.<CLASS>)`, where <CLASS> can be determined from
    `squad_reboot.ode.ode_classes[<transform>]. E.g
    `squad_reboot.ode.ode_classes['squad']', when a SQUAD transformer is
    applicable.
